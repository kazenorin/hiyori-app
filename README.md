...
| .deb     | `src-tauri/target/release/bundle/deb/BYOA_0.4.0_amd64.deb`    |
| .rpm     | `src-tauri/target/release/bundle/rpm/BYOA-0.4.0-1.x86_64.rpm` |
...
| NSIS installer | `src-tauri/target/x86_64-pc-windows-gnu/release/bundle/nsis/BYOA_0.4.0_x64-setup.exe` |
