...
describe('message-updater', () => {
	describe('applyParserOutput', () => {
		it('appends text', () => {
			const result = applyParserOutput(emptyState, { text: 'Hello', thinking: null, gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
		...
		it('appends thinking', () => {
			const result = applyParserOutput(emptyState, { text: null, thinking: 'reasoning', gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
		...
		it('sets valid gameData', () => {
			...
			const result = applyParserOutput(emptyState, { text: null, thinking: null, gameData: gd, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
		...
		it('appends text and thinking together', () => {
			const result = applyParserOutput(emptyState, { text: 'content', thinking: 'thought', gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
			expect(result.content).toBe('content');
			expect(result.reasoning).toBe('thought');
		});

		it('accumulates across multiple calls', () => {
			let state = applyParserOutput(emptyState, { text: 'Hello', thinking: null, gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
			state = applyParserOutput(state, { text: ' world', thinking: ' think', gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
			expect(state.content).toBe('Hello world');
			expect(state.reasoning).toBe(' think');
		});

		it('returns new object (immutable)', () => {
			const result = applyParserOutput(emptyState, { text: 'x', thinking: null, gameData: null, reviewScratchpad: null, revisedNarrative: null, revisedGameData: null });
