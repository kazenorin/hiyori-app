...
export type MultiHeaders = { type: 'multi-headers'; content?: string; headerLevel?: number } & BaseMatch;
...
export type MatchDescriptor = HeaderMatch | MultiHeaders | ListMatch | ListItemMatch | ListLabeledItemMatch;
