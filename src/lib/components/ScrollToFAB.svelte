...
<button
	...
	onclick={handleClick}
	class="mx-auto -mt-9 mb-2 z-10 rounded-full
	       h-10 w-10 flex items-center justify-center
	       bg-surface-50-950 border border-surface-200-700
	       shadow-lg transition-all duration-150
	       {visible ? 'opacity-50 pointer-events-auto hover:opacity-100 hover:shadow-xl hover:border-primary-500' : 'opacity-0 pointer-events-none'}"
>
